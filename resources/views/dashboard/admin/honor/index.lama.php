            ...
            $('.payhonor').click(function(){
                ...
                $.ajax({
                    success: function(response) {
                        ...
                        `<input type="number" name="fungsional" class="form-control" value="" placeholder="Honor Fungsional">` + `<br>`+
                        `<textarea name="keterangan"  class="form-control" rows="4" cols="70" placeholder="Keterangan"></textarea>` + `<br>`+
